      ...
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <a href="mailto:mazhar@example.com" className="text-gray-400 hover:text-primary transition-colors">
              mazhar@example.com
            </a>
          </motion.div>
          ...
          >
            ...
            <a href="tel:+923001234567" className="text-gray-400 hover:text-primary transition-colors">
              +92 300 1234567
            </a>
          </motion.div>
        ...
        <div className="border-t border-primary/20 pt-8">
          ...
          <p className="text-center text-gray-500 text-sm">
            © 2024 Mazhar Ali (Alee GFX). All rights reserved.
          </p>
        </div>
      </div>
    </footer>
